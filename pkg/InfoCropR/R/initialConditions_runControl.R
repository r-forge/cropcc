# control
initialConditions_runControl <- function(DINDEXs, crop, management, pestD,
...
#==================
# control <- initialConditions_runControl(DINDEXs,crop,management,pestD,phenology,soilD,tabFunction,weather,control)